...
export function SubscriptionLimitBanners({ resource, enabled = true }: SubscriptionLimitBannersProps) {
  ...
  const entries = [
    { resource: "branch" as const, label: "branch", entry: limits.branches },
    { resource: "student" as const, label: "student", entry: limits.students },
    { resource: "teacher" as const, label: "teacher", entry: limits.teachers },
