        ...
        {toasts.map((toast) => {
          ...
          return (
            <div
              key={toast.id}
              role="status"
              className={`animate-fade-in pointer-events-auto flex w-full max-w-sm items-start gap-2 rounded-lg border border-l-4 border-slate-200 p-3 shadow-lg ${styles.border} ${styles.bg}`}
            >
              {styles.icon}
